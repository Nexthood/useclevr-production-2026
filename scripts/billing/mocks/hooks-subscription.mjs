...
const noopUrl = here("mock-server-runtime.mjs")
...
const SPECIFIER_MOCKS = new Map([
  ...
  ["@/lib/email/subscription-emails", here("mock-subscription-emails.mjs")],
  ["@/lib/email/subscription-emails.ts", here("mock-subscription-emails.mjs")],
  ["next/cache", noopUrl],
  ["server-only", noopUrl],
])
...
const RESOLVED_PATH_MOCKS = [
  ...
  ["/src/lib/db.ts", here("mock-db.mjs")],
  ...
  ["/src/lib/email/subscription-emails.ts", here("mock-subscription-emails.mjs")],
]
