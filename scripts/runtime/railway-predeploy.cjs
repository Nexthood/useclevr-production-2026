...
const migrationStatements = [
  ...
  readMigrationStatement("src/lib/db/migrations/0008_dataset_type.sql"),
  readMigrationStatement("src/lib/db/migrations/0012_credit_engine.sql"),
  readMigrationStatement("src/lib/db/migrations/0013_dataset_business_model.sql"),
  ...
  readMigrationStatement("src/lib/db/migrations/0023_prebookkeeping_vat_learning.sql"),
