...
3. This AI agent must run `project-prompts/ai-memory-collection-post-interaction.md` after each completed request/response cycle and update `project-logs/interactive-log.md`, `project-logs/activity-log.md`, and `docs/AI-interaction/interaction-status.md`.
4. This AI agent must use `project-prompts/ai-memory-collection.md` when collecting learning from another AI chat.
