...
const productIntents: ProductIntentRule[] = [
  ...
  },
  {
    ...
    answer: () =>
      `You can upload files directly in Upload. UseClevr accepts ${usyProductFacts.uploadFormats.join(", ")} with sales, revenue, margin, inventory, or accounting data. After processing, use the Dashboard or AI Assistant for analysis.`,
    followUps: ["Open upload", "File formats", "Why is my upload blocked?", "Analyze my dataset"],
    actions: ["OPEN_UPLOAD", "OPEN_DATASETS"],
  },
  {
    id: "upload-trouble",
  ...
  },
  {
    ...
    followUps: ["Open billing", "View invoices", "Upgrade plan", "Contact support"],
    actions: ["OPEN_BILLING", "OPEN_SUBSCRIPTION"],
  },
  {
    id: "reports",
  ...
  },
  {
    ...
    answer: () =>
      "You can manage AI providers in Account → AI Providers. Here you can configure which AI models to use, set up your own API keys (BYOK), and adjust provider settings.",
    followUps: ["Open AI providers", "Configure AI", "Local AI", "Contact support"],
    actions: ["OPEN_AI_PROVIDERS", "OPEN_DATA_CONNECTIONS"],
  },
  {
    id: "account",
    keywords: [
    ...
    followUps: ["Open profile", "Open preferences", "Billing help", "Contact support"],
  ...
  },
  {
    ...
    followUps: ["Open AI activity", "View traces", "Provider status", "Contact support"],
    actions: ["OPEN_AI_ACTIVITY"],
  },
];
