...
const profiles: Record<ReportProfileId, ReportProfile> = {
  ...
  professional_services: {
    ...
    primaryMetrics: ["Revenue", "Clients", "Projects / Engagements", "Billable Hours", "Utilization", "Hourly Rate", "Revenue per Professional", "Margin"],
    secondaryMetrics: ["Client Concentration"],
    sections: [
      { id: "professional-services-summary", title: "Professional Services Summary" },
      { id: "utilization-revenue", title: "Utilization & Revenue Performance" },
      { id: "client-concentration", title: "Client Concentration" },
