...
const faqSeed = [
  ...
  },
  {
    ...
    question: "How does UseClevr answer AI questions?",
    answer: "UseClevr provides cloud analysis for standard workflows and UseClevr Hybrid AI for private analysis on your device. Files stay on your device when Hybrid AI is active.",
    sortOrder: 1,
    scope: "public" as const,
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Hybrid AI connects to UseClevr Helper on your device. UseClevr Helper processes private analysis locally.",
    sortOrder: 4,
    scope: "public" as const,
  },
  {
  ...
  },
  {
    ...
    answer: "No. UseClevr never uses your uploaded data, questions, or generated reports to train external systems.",
    sortOrder: 4,
    scope: "public" as const,
  },
  {
    ...
    answer: "UseClevr works on all modern browsers: Chrome, Firefox, Safari, and Edge (latest two stable versions). Hybrid AI Lite requires UseClevr Helper.",
    sortOrder: 1,
    scope: "public" as const,
  },
  {
  ...
  },
  {
    ...
    answer: "Self-hosting is not part of the standard public plans. Contact sales@useclevr.com if you need to discuss a future private setup.",
    sortOrder: 4,
    scope: "public" as const,
  },
  {
