    ...
    <div className="app-topbar min-h-16">
      <div className="flex w-full items-center justify-end">
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/pricing"
            className="hidden items-center gap-1.5 rounded-full px-3 py-2 text-xs font-semibold text-slate-900 transition hover:bg-slate-100 md:inline-flex dark:text-white dark:hover:bg-slate-900"
          >
            <span>Plans</span>
