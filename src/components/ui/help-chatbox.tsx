    ...
    <div className="fixed bottom-4 right-4 z-[120] flex max-w-[calc(100vw-2rem)] flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      {open && (
        ...
        >
          ...
          <div ref={transcriptRef} className="min-h-0 flex-1 space-y-4 overflow-y-auto px-4 py-4 sm:px-5">
            {messages.length === 0 ? (
              <div className="space-y-5">
                <div className="relative overflow-hidden rounded-[26px] border border-cyan-200/15 bg-[linear-gradient(145deg,rgba(255,255,255,0.11),rgba(255,255,255,0.045))] px-5 py-7 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
                  ...
                  <div className="mt-7 inline-flex items-center gap-2 rounded-full border border-cyan-200/30 bg-cyan-200/10 px-3 py-1 text-xs font-medium text-cyan-50">
                    <span className="h-2 w-2 rounded-full bg-emerald-300 shadow-[0_0_14px_rgba(110,231,183,0.9)]" />
                    Always here to help
                  </div>
                  <h3 className="mt-4 text-2xl font-semibold tracking-tight">Hi, I'm Usy 👋</h3>
                  <p className="mt-1 text-sm font-medium text-cyan-50">Your AI Business Intelligence Assistant.</p>
                ...
                <div>
                  <p className="mb-2 text-sm font-semibold text-slate-100">What can I help you with today?</p>
                ...
                <div className="rounded-[24px] border border-white/10 bg-white/[0.05] p-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
          ...
          <form className="border-t border-cyan-100/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.84),rgba(8,13,30,0.96))] p-3 sm:p-4" onSubmit={handleQuestion}>
            <div className="rounded-[24px] border border-cyan-200/[0.18] bg-white/[0.08] p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_18px_50px_rgba(2,6,23,0.22)] focus-within:border-cyan-200/70 focus-within:shadow-[0_0_0_1px_rgba(34,211,238,0.22),0_20px_56px_rgba(34,211,238,0.13)]">
              <textarea
                ref={inputRef}
                value={query}
              ...
              <div className="flex items-center justify-between gap-3 px-1 pb-1">
                ...
                <Button
                  ...
                  className="h-10 w-10 rounded-full bg-gradient-to-br from-cyan-200 via-sky-200 to-fuchsia-200 text-slate-950 shadow-[0_0_22px_rgba(34,211,238,0.28)] hover:opacity-95"
