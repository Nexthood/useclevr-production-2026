        ...
        {step === "terms" && (
          <div className="space-y-6">
            <div className="rounded-lg border border-border bg-background p-5">
              ...
              <label className="mt-4 flex items-start gap-3 rounded-lg border border-border bg-background p-4 cursor-pointer">
                <input
                  type="checkbox"
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    You can also read the full document at{' '}
                    <a href={tscUrl} target="_blank" rel="noopener noreferrer" className="text-primary underline">
                      useclevr.com/terms
                    </a>.
                  </p>
            ...
            <div className="rounded-lg border border-border bg-background p-5">
              ...
              <div className="mt-4 space-y-2">
                <CheckoutConfirmButton planId={planId} />
