      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden px-4 py-16 md:px-6 md:py-20">
          ...
          <div className="container mx-auto">
            <div className="mx-auto grid max-w-7xl min-w-0 items-center gap-10 lg:grid-cols-[0.88fr_1.12fr]">
              <div className="min-w-0 space-y-8 text-center lg:text-left">
                <div className="inline-flex max-w-full flex-wrap items-center justify-center gap-2 rounded-full border border-cyan-700/30 bg-cyan-500/10 px-4 py-2 text-sm font-medium text-cyan-800 shadow-sm shadow-cyan-950/5 dark:border-cyan-300/30 dark:text-cyan-100">
                  <Sparkles className="h-4 w-4" />
                  AI data analyst for business spreadsheets
                </div>

                <div className="space-y-5">
                  <h1 className="break-words text-4xl font-bold tracking-tight text-balance md:text-6xl">
                ...
                <div className="flex min-w-0 flex-col justify-center gap-4 pt-2 sm:flex-row sm:flex-wrap lg:justify-start">
                  <Link href="/signup" className="min-w-0" prefetch={false}>
                    <Button
                      size="lg"
                      className="h-auto min-h-12 w-full max-w-full whitespace-normal rounded-full bg-primary px-8 text-center text-base leading-tight text-primary-foreground shadow-lg shadow-black/10 hover:bg-primary/90 sm:w-auto dark:shadow-black/30"
                    >
                      Analyze your data
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                  </Link>
                  <Link href="/sample-report" className="min-w-0" prefetch={false}>
                    <Button
                      size="lg"
                      variant="outline"
                      className="h-auto min-h-12 w-full max-w-full whitespace-normal rounded-full border-border bg-transparent px-8 text-center text-base leading-tight hover:bg-slate-950 hover:text-white sm:w-auto dark:hover:bg-white dark:hover:text-slate-950"
                    >
                      View sample report
                    </Button>
                  </Link>
              ...
              <Card id="ai-report-preview" className="relative min-w-0 overflow-hidden border-white/10 bg-slate-950 p-4 text-left text-white shadow-2xl shadow-cyan-950/20 backdrop-blur md:p-6">
                  ...
                  <div className="grid min-w-0 gap-4 lg:grid-cols-[0.92fr_1.08fr]">
                    ...
                    <div className="rounded-lg border border-white/10 bg-slate-900/80 p-5">
                      ...
                      <div className="relative h-64 overflow-hidden rounded-lg border border-white/10 bg-slate-950/70 p-3">
                        ...
                        <div className="absolute bottom-4 left-4 right-4 max-w-[calc(100%-2rem)] rounded-lg border border-[#A78BFA]/25 bg-slate-950/80 px-3 py-2 text-xs text-slate-200 backdrop-blur sm:right-auto">
        ...
        <section className="container mx-auto px-4 py-6 md:px-6 md:py-10">
          <div className="mx-auto max-w-6xl space-y-8">
            <div className="flex min-w-0 flex-col items-start gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div className="space-y-3">
                <div className="inline-flex max-w-full flex-wrap items-center gap-2 rounded-full border border-primary/50 bg-primary/10 px-4 py-2 text-sm text-primary">
              ...
              <Link href="/news" className="shrink-0" prefetch={false}>
                <Button variant="outline" className="h-auto min-h-11 whitespace-normal bg-transparent text-center leading-tight">
                  View all news
                </Button>
              </Link>
            </div>
        ...
        <section className="container mx-auto px-4 md:px-6 py-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <div className="mb-4 inline-flex max-w-full flex-wrap items-center justify-center gap-2 rounded-full border border-primary/50 bg-primary/10 px-4 py-2 text-sm text-primary">
                Platform Capabilities
              </div>
              <h2 className="mb-4 break-words text-4xl font-bold md:text-5xl">Built for real business decisions</h2>
...
<p className="text-muted-foreground leading-relaxed">
        ...
        <section className="container mx-auto px-4 md:px-6 py-20 border-t border-border/20">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="mb-4 break-words text-4xl font-bold md:text-5xl">Frequently asked questions</h2>
        ...
        <section className="container mx-auto px-4 md:px-6 py-20">
          <Card className="mx-auto max-w-4xl border-cyan-500/20 bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-cyan-500/10 p-8 text-center md:p-12">
            <h2 className="mb-4 break-words text-3xl font-bold md:text-4xl">Ready to unlock your data's potential?</h2>
            ...
            <div className="flex min-w-0 flex-col justify-center gap-4 sm:flex-row sm:flex-wrap">
              ...
              <a href="mailto:sales@useclevr.com" className="min-w-0">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-auto min-h-12 w-full max-w-full whitespace-normal rounded-full border-border/50 bg-transparent px-8 text-center text-base leading-tight hover:bg-slate-950 hover:text-white sm:w-auto dark:hover:bg-white dark:hover:text-slate-950"
                >
                  Contact sales
                </Button>
              </a>
