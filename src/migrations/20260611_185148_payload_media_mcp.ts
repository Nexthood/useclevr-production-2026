...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"label" varchar,
  	"description" varchar,
  	"news_posts_find" boolean DEFAULT false,
  	"news_posts_create" boolean DEFAULT false,
  	"news_posts_update" boolean DEFAULT false,
  	"news_posts_delete" boolean DEFAULT false,
  ...
  ALTER TABLE "news_posts" ADD COLUMN "cover_image_id" integer;
  ALTER TABLE "_news_posts_v" ADD COLUMN "version_cover_image_id" integer;
  ...
  ALTER TABLE "payload_mcp_api_keys" ADD CONSTRAINT "payload_mcp_api_keys_user_id_cms_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."cms_users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "news_posts" ADD CONSTRAINT "news_posts_cover_image_id_media_id_fk" FOREIGN KEY ("cover_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_news_posts_v" ADD CONSTRAINT "_news_posts_v_version_cover_image_id_media_id_fk" FOREIGN KEY ("version_cover_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "news_posts_cover_image_idx" ON "news_posts" USING btree ("cover_image_id");
  CREATE INDEX "_news_posts_v_version_version_cover_image_idx" ON "_news_posts_v" USING btree ("version_cover_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "news_posts" DROP CONSTRAINT "news_posts_cover_image_id_media_id_fk";
  
  ALTER TABLE "_news_posts_v" DROP CONSTRAINT "_news_posts_v_version_cover_image_id_media_id_fk";
  ...
  DROP INDEX "news_posts_cover_image_idx";
  DROP INDEX "_news_posts_v_version_version_cover_image_idx";
  ...
  ALTER TABLE "news_posts" DROP COLUMN "cover_image_id";
  ALTER TABLE "_news_posts_v" DROP COLUMN "version_cover_image_id";
