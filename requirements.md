...
- Deliver the exact typed request text in the confirmed Usy contact payload: natural marker words such as "about" never truncate or rewrite the message, multi-line requests keep their text, and combined one-shot requests keep their full message after the marker.
