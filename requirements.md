...
- Render local retail generated reports as Retail Executive Reports with revenue, gross profit, gross margin, units sold, current stock, inventory value, product or SKU count, low-stock SKUs, reorder-required SKUs, out-of-stock SKUs, average order value when supported, inventory intelligence, product/category/supplier intelligence, retail recommendations, and provenance.
