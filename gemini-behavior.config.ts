...
export const geminiConfig = {
  instructions: [
    ...
    "This AI agent must run docs/AI-interaction/prompt-library/ai-memory-collection-post-interaction.md after each completed request/response cycle and keep only durable learning.",
    "This AI agent must use docs/AI-interaction/prompt-library/ai-memory-collection.md when collecting learning from other AI chats.",
  ],
};
