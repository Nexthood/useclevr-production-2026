...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, sans-serif; line-height: 1.6; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="text-align: center; margin: 30px 0;">
    <a href="${j}" style="display: inline-block; background: #0ea5e9; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600;">Go to Dashboard</a>
  </div>

  <p style="color: #64748b; font-size: 14px;">
    You can manage your subscription at any time from your <a href="${j}" style="color: #0ea5e9;">subscription settings</a>.
  </p>
...
`;return i({to:b,subject:k,html:m,text:`
...
Go to your dashboard: ${j}

You can manage your subscription at any time from your subscription settings.
`,emailType:"subscription_activation"})}async function g(a){let{to:b,planName:c,canceledAt:d,datasetsPreserved:e,purchasedCreditsPreserved:f,dashboardUrl:g}=a,h=`Your ${c} subscription has been cancelled`,j=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
`;return i({to:b,subject:h,html:j,text:`
...
`;return i({to:b,subject:f,html:g,text:`
