...
- T-299. Evaluate restore candidates for legacy report PDF generation and cloud live-data refresh
...
- T-129. Resolve whether the payment readiness page needs provider-specific setup actions after
  Stripe is connected.
...
- T-198. Resolve whether dist branch history should keep exactly two commits or use tags/releases for
