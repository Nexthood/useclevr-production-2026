...
- T-904. Apply centralized Hybrid AI feature gates across frontend, backend routes, provider settings, report/chat pipelines, audit activity, helper roadmap actions, blocked-attempt logs, and user-facing upgrade paths. (labels: ai, billing, security, ui; commit: worktree)
