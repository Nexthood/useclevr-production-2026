...
- T-1026. CI validation pins external GitHub Actions to immutable upstream commit SHAs and fails on moderate-or-higher dependency audit findings. (labels: ci-build, security, testing; commit: worktree)
