...
- T-951. Implement the Enterprise Dataset Intelligence pipeline foundation with scanner registration, ordered execution, progress, structured logs, failure recovery, retry, resume, cancellation, and execution reports. (labels: data, ai, testing; commit: worktree)
