...
- T-1012. Generic business reports resolve invoice identifiers, exact cost fields, and explicit profit fields before building transaction and margin metrics. (labels: reports, metrics, testing; commit: worktree)
