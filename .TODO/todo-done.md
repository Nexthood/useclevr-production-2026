...
- T-1011. Investor portfolio reports resolve invested amount and latest valuation source columns to amount fields before summing portfolio totals. (labels: reports, metrics, testing; commit: worktree)
