...
- T-1015. Derive paired profitability operating profit only from source-backed revenue and complete operating-expense inputs while preserving unavailable gross and net metrics without COGS, interest, or tax. (labels: reports, metrics, testing; commit: worktree)
