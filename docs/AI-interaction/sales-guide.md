...
- Base all analysis on deterministic application logic and verified data.
- Clearly label any assumptions, forecasts, or estimates.
- Cite sources for any external data or benchmarks used.
- Update analysis when underlying data or product calculations change.

## Research Documents

- Keep competitive research current with the latest market data.
