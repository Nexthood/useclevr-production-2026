...
| I-005 | Payload CMS planning is ready but not active implementation. | Product owner | Controlled | Payload work in `.TODO/todo-future.md` (T-537, T-563); migration prompt in `.TODO/todo-migration-payplod.md` until activated. |
