...
| `project-logs/`                        | Developers, AI agents        | Detailed interaction records and compact project activity summaries.                                                         |
| `project-prompts/`                     | Users, developers, AI agents | Reusable prompts kept outside the documentation knowledge base.                                                              |
